                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input name="first_name" value="{{$employee->first_name}}" class="form-control" type="text">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Last Name</label>
                                        <input name="last_name" value="{{$employee->last_name}}" class="form-control" type="text">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="cal-icon" >
                                            ...
                                            <input type="text" value="{{$employee->date}}" id="datepicker" class="form-control" id="date" name="date">
                                        </div>
                                    </div>
                                </div>
									...
									<div class="form-group">
										...
										<div class="profile-upload">
											<div class="upload-img">
												<img id="img" style="max-width:130px;" src="{{asset('employees')}}/{{$employee->photo}}" alt="doctor photo">
											</div>
