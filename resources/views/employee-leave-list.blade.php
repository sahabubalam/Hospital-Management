            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-4 col-6 text-right m-b-30">
                        <a href="/add-employee-leave" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Leave</a>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped custom-table mb-0 datatable">
                                ...
                                <tbody>
                                @foreach($leaveemp as $leave)
                                    <tr>
                                        <td>
                                      
											<img width="28" height="28" src="{{asset('employees')}}/{{$leave->photo}}" class="rounded-circle" alt="">
                                            <h2><a href="#">{{$leave->first_name}} <span>{{$leave->role}}</span></a></h2>
                                        </td>
